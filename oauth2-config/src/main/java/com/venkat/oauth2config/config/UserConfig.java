package com.venkat.oauth2config.config;
...
public class UserConfig extends GlobalAuthenticationConfigurerAdapter {
    ...
    public void init(AuthenticationManagerBuilder auth) throws Exception{
        auth.inMemoryAuthentication()
                .withUser("venkat").password(passwordEncoder.encode("venkat123"))
                .roles("USER","ADMIN","MANAGER").authorities("CAN_READ","CAN_WRITE","CAN_DELETE")
                .and()
                .withUser("srijan").password(passwordEncoder.encode("srijan123"))
